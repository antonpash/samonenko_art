jQuery(document).ready(function($){
	...
	$('.image-picker img, .add-image').on('click', function(){
			var t = $(this);
			...
			if(frame===undefined){
				...
				frame.on( 'open',function(){
					...
					all_selected.map(function(image,index){
						...
						last_image_container.find('.add-image').hide();
						last_image_container.find('.remove-img').show();
