...
function tt_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'     				=> 'TeslaThemes posts', // The plugin name
			'slug'     				=> 'tesla-framework-plugin', // The plugin slug (typically the folder name)
			'source'   				=> get_template_directory() . '/plugins/tesla-framework-plugin/tesla-framework-plugin.zip', // The plugin source
			'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
	 ...
	 */
	$config = array(
		'id'           => 'tt_cre8or',                 // Unique ID for hashing notices for multiple instances of TGMPA.
