...
function toastie_wc_smsb_form_code() {
	...
	if (get_option('toastie_smsb_vk') == 'true') { // Vkontakte
		if (get_option('toastie_smsb_custom_vk')) { // Custom button
			$social_val.='<span class="smsb_vkontakte custom"><script type="text/javascript" src="https://vk.com/js/api/share.js?9"; charset="windows-1251"></script><script type="text/javascript">document.write(VK.Share.button(false, {type: "custom", text: "<img src=\''.get_option('toastie_smsb_custom_vk'). '\'; />"})); </script></span>';
		} else if (get_option('toastie_smsb_format') == 'button') { // Button
			$social_val.='<span class="smsb_vkontakte nocount"><script type="text/javascript" src="https://vk.com/js/api/share.js?9"; charset="windows-1251"></script><script type="text/javascript">document.write(VK.Share.button(false, {type: "round_nocount"})); </script></span>';
		} else if (get_option('toastie_smsb_format') == 'button_count') { // Button with counter
			$social_val.='<span class="smsb_vkontakte hcount"><script type="text/javascript" src="https://vk.com/js/api/share.js?9"; charset="windows-1251"></script><script type="text/javascript">document.write(VK.Share.button(false, {type: "round"})); </script></span>';
		} else if (get_option('toastie_smsb_format') == 'box_count') {	// Box with counter
			$social_val.='<span class="smsb_vkontakte vcount"><script type="text/javascript" src="https://vk.com/js/api/share.js?9"; charset="windows-1251"></script><script type="text/javascript">document.write(VK.Share.button(false, {type: "custom", text: "<img src=\''. plugins_url( 'img/vk-share-button-big.png', __FILE__ ) . '\'; />"})); </script></span>';
		};
	};
...
add_action('social_media_share_buttons', 'toastie_wc_smsb_form_code', 31);
