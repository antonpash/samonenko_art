...
class Tesla_slider{
	...
	public static function init(){
		...
		$slider_config_file = (file_exists(get_stylesheet_directory() . '/theme_config/slider-options.php'))?  get_stylesheet_directory() . '/theme_config/slider-options.php' : get_template_directory() . '/theme_config/slider-options.php';
		...
		if(!isset(self::$slider_config)&&$slider_config_file!=='' && file_exists($slider_config_file)){
			...
			if(file_exists(get_template_directory() . '/tesla_framework/core/teslaframework.php')){
				require_once get_template_directory() . '/tesla_framework/core/teslaframework.php';
				require_once get_template_directory() . '/tesla_framework/core/tt_load.php';
			}else{
				return;
			}
