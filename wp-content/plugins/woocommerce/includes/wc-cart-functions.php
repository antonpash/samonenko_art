...
function wc_add_to_cart_message( $product_id ) {
	...
	if ( 'yes' === get_option( 'woocommerce_cart_redirect_after_add' ) ) {
		...
		$message   = sprintf( '%s <a href="%s" class="button-sm button-outlined align-left text-black uppercase">%s </a>', esc_html( $added_text ), esc_url( $return_to ), esc_html__( 'Continue Shopping', 'woocommerce' ) );
	} else {
		$message   = sprintf( '%s <a href="%s" class="button-sm button-outlined align-left text-black uppercase">%s</a>', esc_html( $added_text ) , esc_url( wc_get_page_permalink( 'cart' ) ), esc_html__( 'View Cart', 'woocommerce' ));
	}
