...
if ( ! function_exists( 'woocommerce_breadcrumb' ) ) {
	...
	function woocommerce_breadcrumb( $args = array() ) {
		$args = wp_parse_args( $args, apply_filters( 'woocommerce_breadcrumb_defaults', array(
			'delimiter'   => '&nbsp;&#47;&nbsp;',
			'wrap_before' => '<nav itemscope itemtype="http://schema.org/BreadcrumbList" class="woocommerce-breadcrumb" >',
			'wrap_after'  => '</nav>',
			'before'      => '',
			'after'       => '',
...
if ( ! function_exists( 'woocommerce_single_variation_add_to_cart_button' ) ) {
	...
	function woocommerce_single_variation_add_to_cart_button() {
		...
		<div class="variations_button">
			...
			<button type="submit" class="single_add_to_cart_button button-sm button-outlined text-black align-left uppercase"><?php echo esc_html( $product->single_add_to_cart_text() ); ?> <i data-icon="ios-cart" data-icon-color="#000" data-icon-size="28"></i></button>
